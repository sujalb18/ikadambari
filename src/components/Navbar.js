            ...
            <nav class="navbar navbar-expand-lg d-flex navbar-dark navcolor">
                <div class="container-fluid d-flex justify-content-between">
                    ...
                    <form class="collapse navbar-collapse" role="search" id="navbarSupportedContent">
                            <input class="form-control d-none d-lg-block" type="search" placeholder="Search" aria-label="Search" />
                    ...
                    <div class="collapse navbar-collapse mx-5" id="navbarSupportedContent" >
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                            ...
                            <li class="nav-item dropdown mx-1">
                                <Link class="nav-link dropdown-toggle" to="/shop" role="button"  aria-expanded="false">Product</Link>
                                <ul class="dropdown-menu mx-1 hover-effect">
